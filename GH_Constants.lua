...
TOOLTIP_TEXT = {
    ...
    ["ItemLevel"] = "^" .. string.gsub(ITEM_LEVEL, " %%d", ""),
    ["LevelRequired"] = "^" .. string.gsub(ITEM_MIN_LEVEL, "%%d", "(.*)") .. "$",
    ["GemSocketEmpty"] = "^" .. EMPTY_SOCKET_PRISMATIC .. "$",
    ["BonusGem"] = "^" .. string.gsub(ITEM_SOCKET_BONUS, ": %%s", "")
}
