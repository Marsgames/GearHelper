...
L["helpConfig"] = "Affiche le panneau de configuration"
L["helpHelp"] = "Affiche cette aide"
L["helpVersion"] = "Affiche la version de l'addon"
L["helpCW"] = "Affiche le panneau des Custom Weights"
L["helpReset"] = "Réinitialise GearHelper et recharge l'interface"
L["helpAdminCommands"] = "Commandes admin :"
L["helpDebug"] = "Active/désactive le mode debug"
L["helpResetDebug"] = "Réinitialise les options de debug"
L["helpReload"] = "Recharge l'interface"
L["helpAin"] = "Teste la fonctionnalité ask-if-needed"
L["helpCreateItemLink"] = "Génère un faux itemLink et affiche son score"
